    ...
    <div class="mt-6 rounded-lg ">
        ...
        <div class="mt-4 ">
            <div class="grid grid-cols-12 " >
                ...
                <div class="col-span-2 border bg-gray-50 font-semibold text-p1-font text-left px-3 py-2">Illness Type</div>
            ...
            <div class="grid grid-cols-12 " >
                ...
                <div class="col-span-2 border text-left p-3  text-p2-font">Illness Type</div>
